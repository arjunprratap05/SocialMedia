                    ...
                    <div className='profile-content'>
                        ...
                        <div className='profile-details'>
                            ...
                            <p className='profile-bio'>{profile.bio}</p>
                             ...
                             <a href={profile.FaInstagram_username} target='_blank' rel="noreferrer" className='profile-username'>@{profile.login}</a>
                            <p className='profile-bio'>{profile.bio}</p>
                            ...
                            <div className='profile-links'>
                             ...
                             <div className='profile-links'>
                                <a href={profile.FaInstagram_username ? `https://instagram.com/${profile.FaInstagram_username}` : '#'} target='_blank' rel="noreferrer" className={`twitter-link ${!profile.twitter_username ? 'not-available' : ''}`}>
                                    <FaInstagram /> {profile.FaInstagram_username ? profile.FaInstagram_username : 'Not Available'}
                                </a>
                                 <a href={profile.FaInstagram} target='_blank' rel="noreferrer" className='profile-url'><FaInstagram />View Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
